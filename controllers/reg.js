...
regValidation = require.main.require(
  "./Validation_rule/registration_validation"
);
...
router.post("/", function (req, res) {
  ...
  validator.validate(data, function (errors, fields) {
    ...
    if (errors) {
      // errors is an array of objects with shape:
      // { field: string, message: string }[]
      // Example: [{ field: 'username', message: 'Username field Required & must be minimum 4 charecters.' }]
